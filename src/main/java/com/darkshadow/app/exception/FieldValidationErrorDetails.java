...
public class FieldValidationErrorDetails {
	...
	public String toString() {
		return "FieldValidationErrorDetails [error_title=" + error_title + ", error_status=" + error_status
				+ ", error_detail=" + error_detail + ", error_timeStamp=" + error_timeStamp + ", error_path="
				+ error_path + ", error_developer_Message=" + error_developer_Message + ", errors=" + errors + "]";
	}
